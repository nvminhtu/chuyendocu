...
function sparkling_paging_nav() {
	...
	<nav class="navigation paging-navigation" role="navigation">
		...
		<div class="nav-links">
			...
			<div class="nav-previous"> <?php next_posts_link( __( '<i class="fa fa-chevron-left"></i> Các nội dung trước', 'sparkling' ) ); ?></div>
			<?php endif; ?>

			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Các nội dung mới hơn <i class="fa fa-chevron-right"></i>', 'sparkling' ) ); ?> </div>
			<?php endif; ?>
...
function tooltipster_scripts_enqueue(){
  wp_enqueue_style('tooltipstercss',get_stylesheet_directory_uri().'/inc/css/tooltipster.css');
  wp_enqueue_style('tooltipster-shadow',get_stylesheet_directory_uri().'/inc/css/tooltipster-shadow.css');
  wp_enqueue_style('tooltipster-light',get_stylesheet_directory_uri().'/inc/css/tooltipster-light.css');
  wp_enqueue_style('tooltipster-punk',get_stylesheet_directory_uri().'/inc/css/tooltipster-punk.css');
  wp_enqueue_script('tooltipster',get_stylesheet_directory_uri().'/inc/js/jquery.tooltipster.min.js',array('jquery'),'3.2.6');
	wp_enqueue_script('tooltipster-scripts',get_stylesheet_directory_uri().'/inc/js/tooltipster-scripts.js',array('jquery','tooltipster'),'1.0.1');
}
