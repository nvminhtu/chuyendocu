...
function sparkling_widgets_init() {
  register_sidebar( array(
	...
	register_sidebar( array(
    'name'          => esc_html__( 'Top Header', 'sparkling' ),
    'id'            => 'top-header',
    'before_widget' => '',
    'after_widget'  => '',
    'before_title'  => '',
  ...
  register_sidebar(array(
    'id'            => 'sidebar-news',
    'name'          =>  esc_html__( 'Sidebar news', 'sparkling' ),
...
function sparkling_scripts() {
  ...
  wp_enqueue_script('slick-js', get_template_directory_uri().'/inc/js/slick.min.js', array('jquery') );
  wp_enqueue_script('share-js', get_template_directory_uri().'/inc/js/share.js', array('jquery') );
  ...
  wp_enqueue_script( 'unveil-js', get_template_directory_uri() . '/inc/js/jquery.unveil.js', array('jquery'), '20140222', true );
